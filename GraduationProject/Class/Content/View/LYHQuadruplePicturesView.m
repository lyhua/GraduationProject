...
#import "LYHQuadruplePicturesView.h"
...
@implementation LYHQuadruplePicturesView
...
-(void)setupUI
{
    [self setupQuadruplePictures];
}

#pragma mark 设置三张或四张图片图片
-(void)setupQuadruplePictures
{
    //创建图片视图
